...
static CPUReadMemoryFunc * const omap3_hsusb_otg_readfn[] = {
    omap3_hsusb_otg_readb,
    omap3_hsusb_otg_readh,
    omap3_hsusb_otg_readw,
};

static CPUWriteMemoryFunc * const omap3_hsusb_otg_writefn[] = {
...
static CPUReadMemoryFunc * const omap3_hsusb_host_readfn[] = {
    omap_badwidth_read32,
    omap_badwidth_read32,
    omap3_hsusb_host_read,
};

static CPUWriteMemoryFunc * const omap3_hsusb_host_writefn[] = {
...
static CPUReadMemoryFunc * const omap3_hsusb_tll_readfn[] = {
    omap_badwidth_read32,
    omap_badwidth_read32,
    omap3_hsusb_tll_read,
};

static CPUWriteMemoryFunc * const omap3_hsusb_tll_writefn[] = {
    omap_badwidth_write32,
    omap_badwidth_write32,
